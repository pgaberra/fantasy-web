...
/**
 * A small ⓘ that explains the control it sits next to, without spending a line of the panel on
 * prose. Used by the popover menus, where every note competes with the settings for room.
 *

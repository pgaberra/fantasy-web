...
/** What a league's draft came to, totalled by the BFF. */
@Injectable({ providedIn: 'root' })
export class LeagueSummaryService {
  private readonly api = inject(Api);

  /**
   * Totals a Yahoo league's drafted teams.
   *
   * <p>The league key is the whole of what goes out: the picks, the teams and the scoring

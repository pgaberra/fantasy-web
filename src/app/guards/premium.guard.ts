...
// sends them to /premium. It is NOT a security boundary — the BFF must enforce entitlement on any
...
export const premiumGuard: CanActivateFn = () => {
  ...
  return entitlement.premium() ? true : router.createUrlTree(['/premium']);
};
